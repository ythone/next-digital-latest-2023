...
const OrangeBarReverse = ({ titre }: Props) => {
    ...
    return (
        <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className='flex items-end justify-end font-opensans gap-2 text-white'>
            {displaybar()}
...
export default OrangeBarReverse